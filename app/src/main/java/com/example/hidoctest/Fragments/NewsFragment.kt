...
class NewsFragment : Fragment() {
    ...
    {
        rvHeadline = view.findViewById(R.id.recyclerView)
        ...
        newsViewModel.getNewsRepository()?.observe(this) { newsResponse ->
            ...
            val newsArticles: List<NewsArticle> = newsResponse?.newsArticles!!
    ...
    private fun setupRecyclerView() {
        if (newsAdapter == null) {
            newsAdapter = context?.let { NewsAdapter(it, articleArrayList) }
